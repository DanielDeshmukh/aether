...
# NOTE: The remediation WebSocket handler has been removed from this file.
# The canonical handler lives in backend/app/api/main.py and supports both
# "generate_fix" and "create_pull_request" actions.
