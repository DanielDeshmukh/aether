  ...
  return (
    <nav className="fixed top-0 z-50 flex w-full items-center justify-between border-b border-white/5 bg-[#050505]/90 px-6 py-5 backdrop-blur-md md:px-10">
      ...
      <div className="flex items-center gap-3 md:gap-6">
        <div className="hidden items-center gap-2 border border-[rgba(0,255,65,0.28)] bg-[rgba(0,255,65,0.08)] px-3 py-2 text-[9px] font-black tracking-[0.24em] text-[#00ff41] md:flex">
        ...
        <button
          ...
          className="chamfer-button hidden border border-[rgba(255,255,255,0.1)] bg-transparent px-4 py-3 text-[10px] font-black tracking-[0.28em] text-[#8f8a78] transition-colors hover:border-[rgba(255,0,0,0.4)] hover:text-[#ff0000] md:block"
        >
          Exit
        </button>
      </div>
