      ...
      <div className="max-w-[1200px] mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-8">
              <div className="w-10 h-9 bg-lambo-black">
                <img src="/images/logo.png" alt="AETHER" />
              </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4 text-[10px] tracking-[0.2em] text-lambo-ash uppercase font-bold">
              <Link href="/security" className="hover:text-lambo-white transition-colors">Security</Link>
              <Link href="/legal" className="hover:text-lambo-white transition-colors">Legal</Link>
              <Link href="/join-us" className="hover:text-lambo-gold transition-colors text-lambo-gold">Join Us</Link>
            </div>
          </div>
        </div>
        ...
        <div className="pt-10 border-t border-lambo-charcoal/20 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-[9px] text-lambo-ash tracking-[0.2em] uppercase">
            &copy; 2026 AETHER PLATFORM // ALL RIGHTS RESERVED
          </p>
