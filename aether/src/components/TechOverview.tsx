          ...
          <div className="lg:w-1/2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
              {[
                ...
                { label: "Intelligence", value: "NVIDIA NIM", detail: "Payload Generation" },
          ...
          <div className="lg:w-1/2 w-full">
            <div className="aspect-square bg-[#0c0c0d] border border-[#d4af37]/30 flex items-center justify-center relative overflow-hidden group font-mono rounded-3xl">
              <svg className="w-[85%] h-[85%]" viewBox="0 0 400 400">
                <defs>
                  ...
                  <pattern id="radar-grid" width="400" height="400" patternUnits="userSpaceOnUse">
                    {Array.from({ length: 9 }).map((_, i) => (
                      <circle key={i} cx="200" cy="200" r={(i + 1) * 20} fill="none" stroke="#d4af37" strokeWidth="0.4" opacity="0.25" />
                    ))}
                    {Array.from({ length: 12 }).map((_, i) => (
                      <line key={i} x1="200" y1="200" x2="200" y2="10" stroke="#d4af37" strokeWidth="0.4" opacity="0.1" transform={`rotate(${i * 30} 200 200)`} />
                    ))}
                  </pattern>
                </defs>
                ...
                <g filter="url(#bloom)" className="animate-radar-sweep" style={{ transformOrigin: "200px 200px" }}>
                  <line x1="200" y1="200" x2="380" y2="200" stroke="#d4af37" strokeWidth="2" opacity="0.6"/>
                  <path d="M 200 200 L 380 200 A 180 180 0 0 0 373.2 143.5 Z" fill="rgba(212,175,55,0.4)" fillOpacity="0.4"/>
                </g>
